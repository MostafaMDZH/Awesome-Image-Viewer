(self.webpackChunk_N_E=self.webpackChunk_N_E||[]).push([[16],{3991:function(a,b){"use strict";class c{constructor(a){var b,d,e,f;c.appendCSS(),this.viewID=c.generateViewID();let g=c.getHtml(this.viewID,this.isZoomable=null===(b=a.isZoomable)|| void 0===b||b);document.body.appendChild(g),this.view=document.getElementById(this.viewID.toString())||document.createElement("div"),this.images=a.images,this.currentSelected=null!==(d=a.currentSelected)&& void 0!==d?d:0,this.buttons=a.buttons,this.showThumbnails=null===(e=a.showThumbnails)|| void 0===e||e,this.isInZoom=!1,this.stretchImages=null!==(f=a.stretchImages)&& void 0!==f&&f,this.isHudShow=!0,this.dbcTimer=setTimeout(()=>{},0),this.dbcWaiting=!1,this.showImages(),this.showToolbar(),this.addEventToArrows(),this.echoThumbnails(),this.selectImage(this.currentSelected),this.addEventToSwipe(a=>{alert("swiped: "+a);let b=this.currentSelected;"RIGHT"===a?b--:b++,this.selectImage(b)},()=>{alert("doesn't swiped"),this.selectImage(this.currentSelected)}),this.addEventToHudAndZoom(),this.addEventToWindowResize(),this.setStyle(a.style),this.addEventToHide(),this.show()}static appendCSS(){if(null===document.getElementById("imageViewer-style")){let a=document.head||document.getElementsByTagName("head")[0],b=document.createElement("style");b.id="imageViewer-style",a.appendChild(b),b.appendChild(document.createTextNode(d))}}static generateViewID(){let a=Math.floor(1e9*Math.random())+1e8,b=document.getElementById(a.toString());return null===b?a:c.generateViewID()}static getHtml(a,b){let d=`
